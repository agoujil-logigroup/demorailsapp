...
class DeclarationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create declaration" do
    assert_difference('Declaration.count') do
      post declarations_url, params: { declaration: { carte: @declaration.carte, declaration: @declaration.declaration, float: @declaration.float, produit: @declaration.produit, projet: @declaration.projet, user_id: @declaration.user_id } }
    end
  ...
  test "should update declaration" do
    patch declaration_url(@declaration), params: { declaration: { carte: @declaration.carte, declaration: @declaration.declaration, float: @declaration.float, produit: @declaration.produit, projet: @declaration.projet, user_id: @declaration.user_id } }
